...
public abstract class AbstractJDBCTemplate {
    ...
    public <T> List<T> executeQuery(String sql, RowMapper<T> rowMapper, Object[] params) throws Exception {
        //获取链接
    ...
    private ResultSet executeQuery(PreparedStatement prepareStatement, Object[] params) throws Exception {
    ...
    private void closedResultSet(ResultSet resultSet) throws Exception {
        resultSet.close();
    }

    private void closedStatement(PreparedStatement statement) throws Exception {
        statement.close();
    }

    private void closedConnection(Connection connection) throws Exception {
        connection.close();
    }
